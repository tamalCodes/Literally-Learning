...
- [What are the types of Indexes available in MongoDB?](#what-are-the-types-of-indexes-available-in-mongodb)
- [Explain Index Properties in MongoDB?](#explain-index-properties-in-mongodb)
...
- [Can you create an index in an array field in MongoDB?](#can-you-create-an-index-in-an-array-field-in-mongodb)
- [Why does Profiler use in MongoDB?](#why-does-profiler-use-in-mongodb)
- [How to remove attribute from MongoDB Object?](#how-to-remove-attribute-from-mongodb-object)
- [What is "Namespace" in MongoDB?](#what-is-namespace-in-mongodb)
- [What is Replication in Mongodb?](#what-is-replication-in-mongodb)
- [What is Replica Set in MongoDB?](#what-is-replica-set-in-mongodb)
- [How does MongoDB ensure high availability?](#how-does-mongodb-ensure-high-availability)
- [What is an Embedded MongoDB Document?](#what-is-an-embedded-mongodb-document)
...
- [What are the differences between MongoDB and SQL-SERVER?](#what-are-the-differences-between-mongodb-and-sql-server)
- [How can you achieve transaction and locking in MongoDB?](#how-can-you-achieve-transaction-and-locking-in-mongodb)
- [When to Use MongoDB Rather than MySQL?](#when-to-use-mongodb-rather-than-mysql)
- [How MongoDB supports ACID transactions and locking functionalities?](#how-mongodb-supports-acid-transactions-and-locking-functionalities)
- [What are the best practices for MongoDB Transactions?](#what-are-the-best-practices-for-mongodb-transactions)
- [Explain limitations of MongoDB Transactions?](#explain-limitations-of-mongodb-transactions)
- [Should I normalize my data before storing it in MongoDB?](#should-i-normalize-my-data-before-storing-it-in-mongodb)
- [What is upsert operation in MongoDB?](#what-is-upsert-operation-in-mongodb)
...
- [How to perform a delete operation in MongoDB?](#how-to-perform-a-delete-operation-in-mongodb)
...
- [Can one MongoDB operation lock more than one database?](#can-one-mongodb-operation-lock-more-than-one-database)
...
- [Does MongoDB provide a facility to do text search?](#does-mongodb-provide-a-facility-to-do-text-search)
...
- [How to condense large volumes of data in Mongodb?](#how-to-condense-large-volumes-of-data-in-mongodb)
- [Explain relationships in MongoDB?](#explain-relationships-in-mongodb)
...
- [Explain what is horizontal scalability in mongodb?](#explain-what-is-horizontal-scalability-in-mongodb)
...
#  Explain what is horizontal scalability in mongodb?
